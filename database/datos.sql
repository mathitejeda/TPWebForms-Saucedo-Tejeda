...
insert into mesas(ocupada,IDMozo) values (0,2)
insert into mesas(ocupada,IDMozo) values (1,2)
insert into mesas(ocupada,IDMozo) values (0,2)
insert into mesas(ocupada,IDMozo) values (1,2)
...
insert into insumos(nombre,precio,stock,idtipo) values('pepsi',150,1000,1)
insert into insumos(nombre,precio,stock,idtipo) values('coca',150,1000,1)
insert into insumos(nombre,precio,stock,idtipo) values('pan',50,1000,2)
insert into insumos(nombre,precio,stock,idtipo) values('fideos con tuco',500,1000,3)
insert into insumos(nombre,precio,stock,idtipo) values('milanesa',300,1000,3)
insert into insumos(nombre,precio,stock,idtipo) values('helado',250,1000,4)